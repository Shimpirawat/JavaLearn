...
/*
 -Variable in Java is a data types container that saves the data values during Java program execution.
 ...
 -> In java, there are three types of variables:-
       ...
       3.Static Variables: 
         ...
         - These static variables should be initialized first, before the initialization.
